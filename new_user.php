...
<table id="structure">
	<tr>
		<td id="navigation">
            <a href="staff.php" class="red">Return to Menu</a><br />
            <br />
		...
		<td id="page">
            ...
            <form action="new_user.php" method="post">
                <table>
                    <tr>
                        <td>Username:</td>
                        <td><input type ="text" name = "username" maxlenght="30" value="<?php
                    ...
                    <tr>
                        <td colspan="2"><input type="submit" value="Create user" name="submit" /></td>
                    </tr>
                </table>                    
            </form>
		</td>
